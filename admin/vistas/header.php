...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <img src="../public/img/logo_mini.png" width="45px" class="logo-mini">
      <!-- logo for regular state and mobile devices -->
      <img src="../public/img/logo.png" width="130px" class="logo-lg">
...
?>
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-list-alt"></i> <span>Asistencias</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="rptasistencia.php"><i class="fa fa-circle-o"></i> Reporte</a></li>
        </ul>
      </li>
<?php } ?>
      ...
      <li>
        <a href="https://fitsoftwareperu.com/">
          <i class="fa  fa-exclamation-circle">
            
          </i> <span>Acerca de</span>
        </a>
      </li>   
