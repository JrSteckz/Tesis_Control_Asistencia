	...
	case 'listar':
		...
		while ($reg=$rspta->fetch_object()) {
			$data[]=array(
				...
				"7"=>($reg->estado)?'<button class="btn btn-primary btn-x" onclick="mostrar('.$reg->idusuario.')"><i class="fa fa-pencil"></i></button>'.' '.'<button class="btn btn-default btn-x" onclick="mostrar_clave('.$reg->idusuario.')"><i class="fa fa-key"></i></button>'.' '.'<button class="btn btn-danger btn-x" onclick="desactivar('.$reg->idusuario.')"><i class="fa fa-close"></i></button>':'<button class="btn btn-primary btn-x" onclick="mostrar('.$reg->idusuario.')"><i class="fa fa-pencil"></i></button>'.' '.'<button class="btn btn-default btn-x" onclick="mostrar_clave('.$reg->idusuario.')"><i class="fa fa-key"></i></button>'.' '.'<button class="btn btn-primary btn-x" onclick="activar('.$reg->idusuario.')"><i class="fa fa-check"></i></button>'
				);
		}
